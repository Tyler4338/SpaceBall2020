...
public class Robot extends TimedRobot {
  ...
  public final XboxController pilot = new XboxController(Constants.k_Controler_port);
  ...
  public void teleopInit() {
    m_robotContainer.resetTele();
    //m_robotContainer.setSafety();
